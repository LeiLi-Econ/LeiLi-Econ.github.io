...
## Motivation
This is my first research at Nanchang University, under the supervision of Professor Huwei Wen. The literature on how digitalization promotes innovation is already rich, but we find that most of these studies focus on the factor level — that is, supplementing the elements that innovators or regional economies lack for innovation, such as capital, human capital, and technology transfer. However, few studies have simultaneously noticed the following facts: (1) as a product, new technology relies on market networks to circulate and realize its value; (2) the network effects and virtualization of digitalization are reshaping the previously capital-intensive and strongly "place-based" innovation paradigm. These overlooked points are crucial for explaining why scarce innovation factors such as ecological endowments have not been effectively exploited.

Because the comparison and dynamic evolution of factor structures are involved, we build our theoretical framework on new structural economics (NSE). During the peer review process, a reviewer raised the distinction between our concept of "innovation paradigm" and "innovation system" theory. While trying to clarify the conceptual difference, I found that innovation system theory is in fact particularly well suited to illustrating the starting point of dynamic evolution and two-way convergence. The theory of this paper is therefore an appropriate dynamic extension of innovation system theory with the help of NSE: the innovation supply paradigm is the static state of the innovation system at different points in time under different factor structures, while the endogenous evolution of the innovation paradigm belongs to the theoretical domain of NSE.
